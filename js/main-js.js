...
$(document).ready(function() {
	$("#header span#icon-respon-menu").click(function() {
		$("#header #respon-right").stop().fadeToggle(500);
...
// handle auto self moving
$(document).ready(function() {
	var positionActiveCurrent = $(".active-bn").index();
	$(".btn-next-banner").click(function() {
		console.log(positionActiveCurrent);
		var x = positionActiveCurrent + 1;
		$(".slide-box .list-slide .slide").eq(positionActiveCurrent + 1).stop().fadeIn();
